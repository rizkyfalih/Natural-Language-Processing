...
corpus = [['adik','bermain','sepeda','di','halaman','rumah'],
          ['adik','bermain','kelereng','di','lapangan','kemarin','sore'],
          ['aku','bermain','lego','di','rumah','tadi','sore'],]
...
adik_vec = w2v.word_vec('adik')
aku_vec = w2v.word_vec('aku')
kelereng_vec = w2v.word_vec('kelereng')
print('adik vector')
print(adik_vec)
print('aku vector')
print(aku_vec)
print('kelereng vector')
print(kelereng_vec)
w2v.word_sim('adik',3)
w2v.word_sim('kelereng',3)
